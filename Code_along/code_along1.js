...
var person1 = {name: "Adi", age: 22, lname: "VB"}
var person2 = {age: 22, name: "Adi", lname: "VB"}

var p1= Object.getOwnPropertyNames(person1)
var p2 = Object.getOwnPropertyNames(person2)

var p1val = Object.values(person1)
var p2val = Object.values(person2)
...
if (p1.length == p2.length) {
    ...
    if (count == p1.length) {
        ...
        for (let i = 0; i < p1val.length; i++) {
            for (let j = 0; j < p2val.length; j++) {
                if (p1val[i] == p2val[j]) {
                    count++   
                }
            }
        }
        if (count == p1val.length) {
